...
namespace Car_Fun
{
    public partial class Keyboard_EngNumber : Form
    {
        ...
        private void Keyboard_Number_Load(object sender, EventArgs e)
        {
            ...
            {
                if (con.Name.Substring(0, 6) == "button")
                {
                    con.Click += btnNumber_Click;
                }
            }
        }

        private void Keyboard_EngNumber_VisibleChanged(object sender, EventArgs e)
        {
            if (Visible)
            {
                //前一個按鈕還原
